...
from regression_utils_cse_cv import CE_Expansion_FitAll
...
if __name__ == '__main__':
    ...
    CEOptions['alpha'] = 1E0
    CEOptions['NumAtten'] = 1

    CEOptions['CALC-CV'] = 'TRUE'

    CEOptions['Optimizer'] = 'L-BFGS-B'
    CEOptions['LossFunction'] = 'FITALL-CSE-SmoothAllClusters'
    CEOptions['lambda'] = 4.0
    CEOptions['MinOptions'] = {'ftol': 2.22E-9, 'gtol': 1.0E-6, 'maxiter': 1E6, 'maxfun': 1E6, 'eps': 1e-08}
    CEOptions['TimeStr'] = timestr

    CEOptions['AdjustWeights'] = 'TRUE'
    CEOptions['GroundStateStr'] = ['0', '1', '44', '189', '4399']
    ...
    #                            excl = ['error'])
    Training_Folders = np.loadtxt('allstrnames.out', str)
